    ...
    <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
      ...
      <tr><td style="background-color:#FBEFD9;border:1px solid #D4B896;padding:52px 48px;">
        ...
        <p style="font-size:15px;line-height:1.7;color:#3D2810;margin:0 0 36px 0;">
          We received a request to reset the password for your DevEdge portal account. Click below to choose a new password. This link expires in <strong>1 hour</strong>.
        </p>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom:36px;">
          <tr>
            <td style="background-color:#C97B3A;">
              <a href="${resetUrl}" style="display:inline-block;padding:15px 36px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:13px;font-weight:700;color:#ffffff;text-decoration:none;letter-spacing:0.07em;text-transform:uppercase;">
                Reset Password &rarr;
              </a>
            </td>
          </tr>
